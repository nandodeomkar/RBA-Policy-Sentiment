...
- [ ] **Build the decision-ingestion pipeline** — implements FR-001 · DoD: PRD §8
...
- [ ] **Ingest the RBA cash-rate target series** — supports FR-004 · DoD: PRD §10 (data dependency)
- [ ] **Build the reconciled hybrid ensemble scorer** — implements FR-002, NFR-002 · DoD: PRD §8, §9
...
- [ ] **Source or build the validation benchmark** — supports NFR-004 (Q-006) · DoD: PRD §9
  - <!-- prefer published/academic labels; fallback = self-label a small held-out set -->
- [ ] **Validate accuracy against the benchmark** — implements NFR-004 · DoD: PRD §9
  - <!-- must reach ≥85% agreement / ≥0.8 rank correlation before any public launch -->
- [ ] **Wire score provenance** — implements NFR-006 · DoD: PRD §9 (every score links to its rba.gov.au source)
